...
import { useState, useMemo }d'use client';
...
function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <Card className="w-full overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl hover:transform hover:-translate-y-1">
...
export default function CatalogPage() {
  ...
  const productsQuery = useMemoFirebase(() => {
    ...
    // Query products belonging to the super admin's business for the public catalog
    return query(
